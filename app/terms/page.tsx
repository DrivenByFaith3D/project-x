  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-warm-gray leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">2. Orders and Payments</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">3. File Requirements</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">4. Shipping</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">5. Intellectual Property</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">6. Limitation of Liability</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">7. Changes to Terms</h2>
          <p>We may update these Terms at any time. Continued use of the Service after changes constitutes acceptance of the new Terms.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">8. Contact</h2>
