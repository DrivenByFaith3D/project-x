    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mb-16">
        <div className="flex-1">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-charcoal mb-4">Driven by Faith, Built by Hand</h1>
        ...
        <div className="shrink-0">
          <div className="relative w-40 h-40 md:w-48 md:h-48">
            <div className="absolute inset-0 bg-taupe/20 rounded-full blur-2xl" />
      ...
      {/* Values */}
      <div className="mb-16">
        <h2 className="text-xl font-bold text-charcoal mb-6">What We Stand For</h2>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={s.step} className="card p-5 flex items-start gap-4">
              <span className="text-2xl font-bold text-taupe-dark shrink-0">{s.step}</span>
              <div>
      ...
      <div className="card p-8 text-center">
        <h2 className="text-xl font-bold text-charcoal mb-2">Ready to print something?</h2>
        <p className="text-warm-gray text-sm mb-5">Create an account and submit your first order today.</p>
