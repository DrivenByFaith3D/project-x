      ...
      <div className="card p-6 mb-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div>
            ...
            <PasswordInput value={currentPassword} onChange={setCurrentPassword} placeholder="Required to change password" />
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1">New Password</label>
            <PasswordInput value={newPassword} onChange={setNewPassword} placeholder="At least 6 characters" minLength={6} />
          </div>
