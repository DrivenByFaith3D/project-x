...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-warm-gray text-sm mb-10">Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>

      <div className="prose prose-invert prose-zinc max-w-none space-y-8 text-warm-gray leading-relaxed">

        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">1. Information We Collect</h2>
          <p>We collect information you provide directly, including:</p>
          <ul className="list-disc list-inside mt-2 space-y-1 text-warm-gray">
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">3. Information Sharing</h2>
          <p>We do not sell your personal information. We share your information only with:</p>
          <ul className="list-disc list-inside mt-2 space-y-1 text-warm-gray">
            <li><strong className="text-warm-gray">Stripe</strong>: for payment processing</li>
            <li><strong className="text-warm-gray">Shippo</strong>: for shipping label generation and tracking</li>
            <li><strong className="text-warm-gray">Brevo</strong>: for transactional email delivery</li>
          </ul>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">4. Data Retention</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">5. Security</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-charcoal mb-3">6. Cookies</h2>
