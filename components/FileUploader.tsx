    ...
    <div>
      <div
        ...
        className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors ${
          dragOver ? 'border-charcoal/40 bg-charcoal/5' : 'border-zinc-300 hover:border-zinc-400'
        }`}
      >
        ...
        {uploading ? (
          ...
          <>
            <svg className="w-8 h-8 text-warm-gray mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
            </svg>
            <p className="text-sm text-warm-gray">
              <span className="text-charcoal font-medium">Click to upload</span> or drag and drop
            </p>
            <p className="text-xs text-warm-gray mt-1">STL, PNG, JPG, GIF, WebP</p>
          </>
        )}
      </div>
